...
def test_public_validation_artifacts():
    ...
    text = " ".join(
        ...
        for x in [
            "reports/public_validation/public_validation_metrics.json",
            "reports/public_validation/public_validation_manifest.json",
            "reports/public_validation/README.md",
        ]
    )
